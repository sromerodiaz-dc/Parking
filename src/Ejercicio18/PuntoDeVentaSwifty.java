 ...
 * */
public class PuntoDeVentaSwifty {
    // Atributos
    ...
    public static PuntoDeVentaSwifty parking = null; // Instancia única de la clase Parking. Singleton

    // Constructores
    private PuntoDeVentaSwifty() {}

    private PuntoDeVentaSwifty(int capacidad, int numCoches) { // Inicializa diversos atributos de la clase desde main
        PuntoDeVentaSwifty.capacidad = capacidad;
        PuntoDeVentaSwifty.coches = new Coche[numCoches];
        PuntoDeVentaSwifty.control = new boolean[capacidad];
    }
     ...
     * @return Parking
     * */
    public static PuntoDeVentaSwifty getInstanceOf(int capacidad, int numCoches) {
        if (parking == null) parking = new PuntoDeVentaSwifty(capacidad, numCoches);  // Inicializa el construcor parametrizado
        return parking;
    }
